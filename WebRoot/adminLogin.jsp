...
<FORM name="adminlogin" action="${pageContext.request.contextPath}/servlet/AdminServlet?flag=AdminLogin" method="post">
            ...
            <TABLE id=table2 cellSpacing=1 cellPadding=0 width="100%" 
              ...
              <TR>
                ...
                <TD><INPUT class=regtxt title=请填写密码 type=password maxLength=16 
                  size=16 name=password></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD>
