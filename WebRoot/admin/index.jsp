...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>购物系统后台管理</TITLE>
...
<UL>
  ...
  <UL>
    ...
    <LI><A href="${pageContext.request.contextPath}/servlet/commodityClassServlet?flag=selectAll" target="frmright">商品种类列表</A> </LI>
    <LI><A href="${pageContext.request.contextPath}/servlet/commodityServlet?flag=add" target="frmright">商品录入</A> </LI>
    <LI><A href="${pageContext.request.contextPath}/servlet/commodityServlet?flag=comAll" target="frmright">商品列表</A> </LI>
 </LI></UL></DIV>
  ...
  href="#">订单管理</A>
    <DIV class=menu_childs onmouseout=Menus.Hide(0);>
  <UL>
    <LI><A href="include/order/orderList.jsp"  target=frmright>订单列表</A> </LI>
    <LI><A href="include/order/orderQuery.htm"     target=frmright>订单查询</A> </LI>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#c4d8ed
        ...
        <TR height=32>
          ...
          <TD background=images/bg2.gif><SPAN
            style="FLOAT: left">购物系统后台管理</SPAN><SPAN
            id=dvbbsannounce
          ...
          background=images/bg2.gif>| <A
            href="${pageContext.request.contextPath}/admin/index.jsp" target=_top>后台首页</A>
            | <A href="${pageContext.request.contextPath}/index.jsp" target="_blank">首页</A> | <A
            href="${pageContext.request.contextPath}/servlet/AdminServlet?flag=exit" target=_top>退出</A> </TD>
