...
<form action="${pageContext.request.contextPath}/servlet/commodityClassServlet?flag=add" method="post">
...
border=0>
  ...
  <TR>
    ...
    <TD class=forumrowhighlight 
      ...
      <input type="reset" value="重置"><font color="red" style="font-size: 12px">${requestScope.msg}</font>
    </span></TD>
  </TR>
  </TBODY></TABLE>
</form>  
