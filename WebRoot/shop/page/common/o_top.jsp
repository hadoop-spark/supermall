...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	...
	<link href="/supermall/style/o_top.css" rel="stylesheet" type="text/css" />
...
<div id="o-header">
	<div class="w" id="header">
    	<div class="fl" id="logo"><a href="index.jsp" style="border:0"><img src="images/logo.png" style="border:0"/></a></div>
