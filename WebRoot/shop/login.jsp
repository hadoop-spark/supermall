...
<html>
	...
	<body>
		...
		<div style="width: 500">
			&nbsp;&nbsp;&nbsp;&nbsp;
			<font color="6C415C" size="5">用户登录</font>
			<br>
				...
				<table width="321" height="118">
					<tr>
						<td height="30" align="right">
							<font style="font-size: 12px">用户名</font>
						</td>
						<td>
					...
					<tr>
						<td height="30" align="right">
							<font style="font-size: 12px">密码</font>
						</td>
						<td>
					...
					<tr>
						<td height="30" align="right">
							<font style="font-size: 12px">用户类型</font>
						</td>
						<td>
							&nbsp;&nbsp;<select >
					...
					<tr>
						<td colspan="2" align="center" height="30">
							<input name="button" type="submit" value="登  录"/>
						</td>
					</tr>
				</table>
